...
impl BSpLineWorkspace {
    ...
    /// individually, due to the nature of the defining recurrence relation.
    pub fn deriv_eval(&self, x: f64, nderiv: usize, dB: &MatrixF64) -> enums::Value {
        unsafe { ffi::gsl_bspline_deriv_eval(x, nderiv, ffi::FFI::unwrap(dB),
                                             self.w) }
    }
    ...
    /// terms.
    pub fn deriv_eval_non_zero(&self, x: f64, nderiv: usize, dB: &MatrixF64, istart: &mut usize,
                         iend: &mut usize) -> enums::Value {
